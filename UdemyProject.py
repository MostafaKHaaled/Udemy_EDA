...
fig5=px.scatter(NewData,x='reviews_count',y='students_count',color='level',marginal_x='rug',marginal_y='box',animation_frame='reviews_avg')
...
fig6=px.scatter(NewData,x='lectures_count',y='course_duration',color="level",animation_frame='reviews_avg')

st.plotly_chart(fig6, theme=None, use_container_width=True)
###################################################################
st.markdown('----')
FIG=px.scatter(NewData,x='lectures_count',y='students_count',color='level',animation_frame='reviews_avg')
